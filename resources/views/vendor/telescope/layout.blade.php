...
<head>
    ...
    <link href="{{ asset(mix($cssFile, 'public/vendor/telescope')) }}" rel="stylesheet" type="text/css">
</head>
<body>
<div id="telescope" v-cloak>
    ...
    <div class="container mb-5">
        <div class="d-flex align-items-center py-4 header">
            ...
            <h4 class="mb-0 ml-3"><strong>Book</strong> Telescope{{ config('app.name') ? ' - ' . config('app.name') : '' }}</h4>
