...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="d-inline">{{ isset($pageTitle) ? $pageTitle : trans('messages.listss') }}</h3>
    ...
    <div class="form-group">
        {!! Form::label('author', trans('messages.author_name') . ' *', ['class' => 'form-control-label']) !!}
        {!! Form::text('author', null, ['class' => 'form-control', 'required', 'placeholder' => trans('messages.author_name')]) !!}
