...
<head>
    ...
    <link href="{{asset('public/plugin/calentim/css/calentim.min.css')}}" rel="stylesheet">
    <link href="{{ asset('public/plugin/rateyo/css/jquery.rateyo.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('public/plugin/jquery-confirm/css/jquery-confirm.min.css') }}" rel="stylesheet" type="text/css" />
