...
<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
        ...
        <a class="navbar-brand pt-0" href="{{ route('home') }}">
            <div class="row">
                <div class="col-sm-12">
                    <img src="https://ramkabirbharat.org/public/storage/4/image-removebg-preview.png" class="navbar-brand-img" alt="site_logo">
                </div>
<!--{{--                <div class="col-sm-12">--}}-->
        ...
        <ul class="nav align-items-center d-md-none">
            ...
            <li class="nav-item dropdown">
              ...
              <span class="avatar avatar-sm rounded-circle">
                <img alt="Image placeholder" src="https://ramkabirbharat.org/public/storage/98/image-removebg-preview.png">
              </span>
                    </div>
                </a>
                <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
...
@php
    ...
    $MyNavBar = \Menu::make('MenuList', function ($menu) use($url){
      ...
      $menu->add('<span>'.__('messages.trending_book').'</span>',['route'  => ['book.index', 'type' => 'top-sell']])
            ->prepend('<i class="fas fa-book text-primary"></i>')
            ->link->attr(['class' => '']);
